    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent thisActivity = new Intent(getApplicationContext(), SecondClass.class);
                startActivity(thisActivity);


            }
        });
        final Button button2 = (Button) findViewById(R.id.freeRoam);
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Perform action on click
                Intent thisActivity = new Intent(getApplicationContext(), MainActivity.class);
                startActivity(thisActivity);
